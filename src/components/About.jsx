        ...
        <Section id="about" className="bg-zinc-900/50 md:px-12 lg:px-20">
            <div className="md:flex gap-12 items-center">
                <div className="md:w-1/2 mb-8 md:mb-0">
                    ...
                    <p className="text-zinc-400 leading-relaxed mb-4">
                        With a strong foundation in <span className="text-white">Full Stack Development</span>, I specialize in building scalable web and mobile applications. My expertise spans across React.js, Node.js, Express.js, SpringBoot and Flutter, backed by robust database knowledge in MongoDB, PostgreSQL, and Redis.
                    </p>
